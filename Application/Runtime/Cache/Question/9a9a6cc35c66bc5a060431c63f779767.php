...
<head>
	...
	<script src="/Public/pagejs/Question/questionupdate.js"></script>
		...
		<div class="page-content">
			<div class="page-content-inner">
				<div class="question-title">
					...
					<div class="title-box">
						<input autocomplete="off" arja-haspopup="true" type="text" name="questiontitle" value="<?php echo ($question['title']); ?>" class="form-text-input questiontitle" placeholder="标题"></input>
					</div>
				</div>
					...
					<div class="tag-section">
						<div class="tag-section-inner clearfix">
							<div class="meta-panel">
								<span class="tags-box">
									<?php if(is_array($questiontags)): $i = 0; $__LIST__ = $questiontags;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$singletag): $mod = ($i % 2 );++$i;?><div class="meta-item tags">
											<a href="javascript:;"><?php echo ($singletag['tag']); ?></a>
				...
				<div class="question-main-editor">
					...
					<div class="question-editor-box">
						<div id="summernote" token="<?php echo ($token); ?>" aid="<?php echo ($aid); ?>" qid="<?php echo ($qid); ?>" url-head="<?php echo ($url_head); ?>"><?php echo ($question['content']); ?></div>
					</div>
					<div class="command clearfix">
						<button href="javascript:;" url="<?php echo U('/Question/Index/updateSubmittedQuestion');?>" class="top-add-question submit-question-text" style="float:right;" status="">发表</button>
						<?php if($question['type'] == 0): ?><span class="save-box">
								<a href="javascript:;" url="<?php echo U('/Question/Index/updateSubmittedDraft');?>" class="saveQuestion" status="">更新草稿</a>
							</span><?php endif; ?>
					</div>
				</div>
			</div>
