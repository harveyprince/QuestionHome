	...
	<div class="hot-nav">
		<div class="tabbable tabs-left">
			<ul class="nav nav-tabs nav-stacked">
				<?php if(!$weektype): ?><li class="active"><a href="<?php echo U('/Question/Index/questionHot');?>">月最热</a></li>
					<li><a href="<?php echo U('/Question/Index/questionHot').'?type=week';?>">周最热</a></li>
				<?php else: ?>
					<li><a href="<?php echo U('/Question/Index/questionHot');?>">月最热</a></li>
					<li class="active"><a href="<?php echo U('/Question/Index/questionHot').'?type=week';?>">周最热</a></li><?php endif; ?>
			</ul>
		</div>
	</div>
		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="subheader">
					...
					<div class="har-tabs">
						<ul class="nav nav-tabs">
							<li class="">
								<a href="<?php echo U('/Question/Index/index');?>">最新</a>
							</li>
							<li class="active">
								<a href="<?php echo U('/Question/Index/questionHot');?>">热门</a>
							</li>
				...
				<div class="main-feed-con navigable" data-feedtype="topstory" data-widget="navigable">
					<?php if(is_array($questionlist)): $i = 0; $__LIST__ = $questionlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$singlequestionitem): $mod = ($i % 2 );++$i; echo W('Question/questionitem',array($singlequestionitem['id']));?>
						<div class="divider"></div><?php endforeach; endif; else: echo "" ;endif; ?>
					<?php if($weektype): ?><a href="javascript:;" page="1" url="<?php echo U('/Question/Index/hotQuestionMoreByWeek');?>" class="button-more question-more">更多</a>
					<?php else: ?>
						<a href="javascript:;" page="1" url="<?php echo U('/Question/Index/hotQuestionMoreByMonth');?>" class="button-more question-more">更多</a><?php endif; ?>
				</div>
			</div>
		</div>
